...
sys.path.append('./yolov7')  # Ensure this points to the folder containing the YOLO v7 code
...
def eval_yolov7():
    ...
    #         model.to(device)
    #         model.eval()
    #         print(f"YOLOv7 weights loaded successfully from {weights_path}")
    #         return model
